...
# variavel singleton para criar nova cadeia com os processos selecionados:
...
class AnaliseSeletiva(AbstractAnalyze):
    """
    ...
    def __init__(self):
        super().__init__("Analise Seletiva das Estrategias")
