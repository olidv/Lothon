...
class AppConfig:
    ...
    TAG_TREVOS = ['1 2', '1 3', '1 4', '1 5', '1 6', '2 3', '2 4', '2 5', '2 6', '3 4', '3 5',
                  '3 6', '4 5', '4 6', '5 6']

    MAP_CLUBES = {'abc/rn': 1, 'abc': 1, 'a b c/rn': 1, 'abcentusjoaoa': 1,
                  ...
                  'fluminense/rj': 27, 'fluminense': 27, 'fluminenseira': 27, 'fluminensesea': 27,
                                       'fluminenseaba': 27, 'fluminenseama': 27,
                                       'fluminenseseo': 27,
                  ...
                  'portuguesa/sp': 55, 'portuguesa': 55, 'p. desportos/sp': 55, 'port desporta': 55,
                                       'port desport': 55,
                  'remo/pa': 56, 'remo': 56, 'remoimundoa': 56, 'remoipeoaoa': 56,
                                 'remoasudese': 56, 'remoiapreta': 56, 'remobrancoara': 56,
                                 'remoeirenseno': 56,
